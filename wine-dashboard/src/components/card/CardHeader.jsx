        ...
        <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                    <h3 className="text-sm text-gray-600 dark:text-gray-200">{title}</h3>
                    {info && (
                        <div className="relative inline-block group">
                            <Info size={12} className="cursor-pointer text-gray-500 dark:text-gray-300" />
            ...
            {icon && <div className="text-gray-600 dark:text-gray-200">{icon}</div>}
        </div>
    );
}
